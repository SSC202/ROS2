...
: ${AMENT_CURRENT_PREFIX:="/data/ROS2/ROS2_Test/Code/12_Sensor_ws/install/ld14"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ld14/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ld14/environment/path.sh"
