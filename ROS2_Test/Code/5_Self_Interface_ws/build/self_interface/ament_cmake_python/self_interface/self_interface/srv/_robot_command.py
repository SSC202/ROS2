...
class Metaclass_RobotCommand_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('self_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_RobotCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'self_interface.srv.RobotCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from self_interface.srv import _robot_command
...
class RobotCommand(metaclass=Metaclass_RobotCommand):
    from self_interface.srv._robot_command import RobotCommand_Request as Request
    from self_interface.srv._robot_command import RobotCommand_Response as Response
