...
static const _RobotCommand_Request_type_support_symbol_names_t _RobotCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, self_interface, srv, RobotCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, self_interface, srv, RobotCommand_Request)),
  }
};
...
{
  return &::self_interface::srv::rosidl_typesupport_cpp::RobotCommand_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, self_interface, srv, RobotCommand_Request)() {
  return get_message_type_support_handle<self_interface::srv::RobotCommand_Request>();
}
...
static const _RobotCommand_Response_type_support_symbol_names_t _RobotCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, self_interface, srv, RobotCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, self_interface, srv, RobotCommand_Response)),
  }
};
...
{
  return &::self_interface::srv::rosidl_typesupport_cpp::RobotCommand_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, self_interface, srv, RobotCommand_Response)() {
  return get_message_type_support_handle<self_interface::srv::RobotCommand_Response>();
}
...
static const _RobotCommand_type_support_symbol_names_t _RobotCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, self_interface, srv, RobotCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, self_interface, srv, RobotCommand)),
  }
};
...
{
  return &::self_interface::srv::rosidl_typesupport_cpp::RobotCommand_service_type_support_handle;
}
