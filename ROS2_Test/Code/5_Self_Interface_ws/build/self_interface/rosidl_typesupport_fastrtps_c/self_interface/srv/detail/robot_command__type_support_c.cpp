...
#include "self_interface/srv/detail/robot_command__rosidl_typesupport_fastrtps_c.h"
...
#include "self_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _RobotCommand_Request__ros_msg_type = self_interface__srv__RobotCommand_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_self_interface
size_t get_serialized_size_self_interface__srv__RobotCommand_Request(
  const void * untyped_ros_message,
...
static uint32_t _RobotCommand_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_self_interface__srv__RobotCommand_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_self_interface
size_t max_serialized_size_self_interface__srv__RobotCommand_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RobotCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_self_interface__srv__RobotCommand_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, self_interface, srv, RobotCommand_Request)() {
...
using _RobotCommand_Response__ros_msg_type = self_interface__srv__RobotCommand_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_self_interface
size_t get_serialized_size_self_interface__srv__RobotCommand_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotCommand_Response__ros_msg_type * ros_message = static_cast<const _RobotCommand_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_self_interface__srv__RobotCommand_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_self_interface
size_t max_serialized_size_self_interface__srv__RobotCommand_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RobotCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_self_interface__srv__RobotCommand_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, self_interface, srv, RobotCommand_Response)() {
...
// already included above
// #include "self_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "self_interface/srv/robot_command.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, self_interface, srv, RobotCommand)() {
