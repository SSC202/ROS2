...
#include "self_interface/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const self_interface::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<self_interface::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &self_interface::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
