...
#include "self_interface/srv/detail/robot_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const self_interface::srv::RobotCommand_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  self_interface::srv::RobotCommand_Request & ros_message)
{
  // Member: distance
  cdr >> ros_message.distance;
...
{
  auto typed_message =
    static_cast<const self_interface::srv::RobotCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<self_interface::srv::RobotCommand_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_self_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<self_interface::srv::RobotCommand_Request>()
{
  return &self_interface::srv::typesupport_fastrtps_cpp::_RobotCommand_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, self_interface, srv, RobotCommand_Request)() {
  return &self_interface::srv::typesupport_fastrtps_cpp::_RobotCommand_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_self_interface
cdr_serialize(
  const self_interface::srv::RobotCommand_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  self_interface::srv::RobotCommand_Response & ros_message)
{
  // Member: pose
  cdr >> ros_message.pose;
...
{
  auto typed_message =
    static_cast<const self_interface::srv::RobotCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<self_interface::srv::RobotCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &self_interface::srv::typesupport_fastrtps_cpp::_RobotCommand_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, self_interface, srv, RobotCommand_Response)() {
  return &self_interface::srv::typesupport_fastrtps_cpp::_RobotCommand_Response__handle;
}
...
{
  return &self_interface::srv::typesupport_fastrtps_cpp::_RobotCommand__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, self_interface, srv, RobotCommand)() {
  return &self_interface::srv::typesupport_fastrtps_cpp::_RobotCommand__handle;
}
